...
fc::variant_object get_config()
{
   ...
   result["SMOKE_CONTENT_CURATE_REWARD_PERCENT"] = SMOKE_CONTENT_CURATE_REWARD_PERCENT;
   ...
   result["SMOKE_GENESIS_TIME_EPOCH"] = SMOKE_GENESIS_TIME_EPOCH;
   ...
   result["SMOKE_MIN_PAYOUT_STEEM"] = SMOKE_MIN_PAYOUT_STEEM;
   ...
   result["SMOKE_SMOKE_ACCOUNT"] = SMOKE_SMOKE_ACCOUNT;
